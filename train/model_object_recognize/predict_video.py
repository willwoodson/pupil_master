...
out = cv2.VideoWriter("../../Data/data_video/predict_object_recognize.avi", fourcc, 20.0, (1280, 480))
...
cap = cv2.VideoCapture("../../Data/data_video/test.avi")  # 参数为视频文件目录
...
while True:
    ...
    df.to_csv("../../Data/data_csv/predict_object_recognize.csv")
    t2 = time.time()
    print("检测耗时:", t2 - t1)
